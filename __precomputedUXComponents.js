function PRECOMPUTEDUX_4016a17f8f0a4b2dae9f1bb958711e78_ux_InvoiceList_Parameter(go) { 
var jsout = [
...
'\tcomponentGUID: \'f3e94302-5ae9-40b1-9991-eef25d38a31b\',',
'\tcolumnInfo: {\'CURRENTUSER\': {info: {controlType: \'textbox\'}, hiddenVal: false, type: \'input,label\', isCalc: false, hlp: \'\', isArray: false, dataType: \'C\'  },\'COMPID\': {info: {controlType: \'textbox\'}, hiddenVal: false, type: \'input,label\', isCalc: false, hlp: \'\', isArray: false, dataType: \'N\'  },\'LIST_OF_INVOICES\': {info: {controlType: \'label\'}, hiddenVal: false, type: \'label,label\', isCalc: false, hlp: \'\', isArray: false, dataType: \'C\'  },\'FROMDATE\': {info: {controlType: \'textbox\'}, hiddenVal: false, type: \'input,label\', isCalc: false, hlp: \'\', isArray: false, dataType: \'D\', validate: function(data,colName,rowNum,instNum) {if($u.s.aTrim(data) == \'\') return \'From Date is Required\'; return true; }  },\'TODATE\': {info: {controlType: \'textbox\'}, hiddenVal: false, type: \'input,label\', isCalc: false, hlp: \'\', isArray: false, dataType: \'D\', validate: function(data,colName,rowNum,instNum) {if($u.s.aTrim(data) == \'\') return \'To Date is Required\'; return true; }  },\'MEDREPN\': {info: {controlType: \'TextBox\',controlSubType: \'Edit-Combo List\'}, hiddenVal: false, type: \'input,label\', isCalc: false, hlp: \'\', isArray: false, dataType: \'C\'  }},',
'\toriginalValues: [{',
'\t"LIST_OF_INVOICES": "",',
'\t"FROMDATE": "",',
'\t"TODATE": "",',
...
'A5.loadJavascript(\'\\n\\n;\\nfunction onChange_currentuser_62083363127a4993a70874204981601b(_dlgObj){if(_dlgObj.executeWatchEventForControl) _dlgObj.executeWatchEventForControl(\\\'CURRENTUSER\\\');};\\nfunction onChange_compid_d099dd92ddc847f4bb7f7a1f0340da79(_dlgObj){if(_dlgObj.executeWatchEventForControl) _dlgObj.executeWatchEventForControl(\\\'COMPID\\\');};\\nfunction onChange_List_of_Invoices_47110ea5be794566be61156196bc7246(_dlgObj){if(_dlgObj.executeWatchEventForControl) _dlgObj.executeWatchEventForControl(\\\'LIST_OF_INVOICES\\\');};\\n\\nfunction onChange_FromDate_1a49a0a355034c91ab51140609ade592(_dlgObj){if(_dlgObj.executeWatchEventForControl) _dlgObj.executeWatchEventForControl(\\\'FROMDATE\\\');};\\nfunction onChange_ToDate_77c436be27244b4ca2037edc3a931ad4(_dlgObj){if(_dlgObj.executeWatchEventForControl) _dlgObj.executeWatchEventForControl(\\\'TODATE\\\');};\\nfunction onChange_MEDREPN_07378059b38944649e44299d1c31dda0(_dlgObj){if(_dlgObj.executeWatchEventForControl) _dlgObj.executeWatchEventForControl(\\\'MEDREPN\\\');};\\n\\n\\n;\\n\');',
'{UXPRERENDEREDALIAS}_DlgObj._controlsThatHaveHiddenProperty = [\'currentuser\',\'compid\']',
'if(typeof {UXPRERENDEREDALIAS}_DlgObj !== \'undefined\' && typeof {UXPRERENDEREDALIAS}_DlgObj.fieldHelpers!== \'undefined\') if(!{UXPRERENDEREDALIAS}_DlgObj.fieldHelpers[\'FROMDATE\']) {  {UXPRERENDEREDALIAS}_DlgObj.fieldHelpers[\'FROMDATE\'] = new A5.EditDateTime({',
'\ttheme: \'Alpha-Magenta\',',
'\tdateTime: {',
...
'});}',
'if(typeof {UXPRERENDEREDALIAS}_DlgObj !== \'undefined\' && typeof {UXPRERENDEREDALIAS}_DlgObj.fieldHelpers!== \'undefined\') if(!{UXPRERENDEREDALIAS}_DlgObj.fieldHelpers[\'TODATE\']) {  {UXPRERENDEREDALIAS}_DlgObj.fieldHelpers[\'TODATE\'] = new A5.EditDateTime({',
'\ttheme: \'Alpha-Magenta\',',
'\tdateTime: {',
'\t\tformat: \'<DefaultDateOnlyFormat>\',',
'\t\tdatePicker: {',
...
'}',
'{UXPRERENDEREDALIAS}_DlgObj.dialogWatches[\'ENABLE_COMPID\'] = {',
'\t\twatch: [],',
'\t\tvariables: [],',
'\t\tonChange: function(data) {',
'\tvar dialog = {};',
...
'\t;',
'\tvar enable = (1 == 2);',
'\tvar eles = $cetp($n(\'V.R\' + data.rowNumber + \'.COMPID\'),$(\'{UXPRERENDEREDALIAS}.R\'+data.rowNumber));',
'\tif(typeof eles.length == \'undefined\' || eles.length == 0) eles = [$(\'{UXPRERENDEREDALIAS}.\'+\'V.R\' + data.rowNumber + \'.COMPID\')];',
'\tvar pObj = {UXPRERENDEREDALIAS}_DlgObj.getControl(\'compid\'); if(pObj) { if(typeof pObj.setDisabled != \'undefined\') {  pObj.setDisabled(!enable,eles); return true;  } }',
'\tvar obj = {UXPRERENDEREDALIAS}_DlgObj.getControl(\'compid\'); if(obj) {obj.readOnly = readOnly}',
'\tif(typeof {UXPRERENDEREDALIAS}_DlgObj._buttons[\'compid\'] != \'undefined\') {',
'\t\t{UXPRERENDEREDALIAS}_DlgObj._buttons[\'compid\'].setDisabled(!enable,eles);',
'\t} else {',
'\t\tfor(var i=0; i<eles.length;i++) eles[i].disabled = !enable;',
'\t}',
'\t;;',
'\t{UXPRERENDEREDALIAS}_DlgObj._executeEvent(\'onWatchEvent\',{type: \'enable\', control: \'compid\', flag: enable});}',
'}',
...
'\t\t\t}',
'\t\t});',
'window[\'{UXPRERENDEREDALIAS}_O_1D337118D73C4466B5137F41409F3A4B\'] = function(rowNum,rowId,objEle) {',
'var runMethod = \'ajax\';',
'if(runMethod == \'ajax\') {',
...
'\tro.reportName = \'listofinvoices@ProjectReport\';',
'\tro.reportNameShort = \'listofinvoices\';',
...
'\tro.filter = \'medrepn = `\'+{UXPRERENDEREDALIAS}_DlgObj.getValue(\'MEDREPN\')+\'` .OR. areamanager= `\'+{UXPRERENDEREDALIAS}_DlgObj.getValue(\'MEDREPN\')+\'` .OR. supervisorn=`\'+{UXPRERENDEREDALIAS}_DlgObj.getValue(\'MEDREPN\')+\'` .OR. lmanager = `\'+{UXPRERENDEREDALIAS}_DlgObj.getValue(\'MEDREPN\')+\'`\';',
'\tro.order = \'\';',
'\tro.sqlFilter = \'\';',
'\tro.mode = \'Odialog2\';',
'\tro.sqlOrder = \'\';',
'\tro.arguments = \'mcomid|Numeric|\'+{UXPRERENDEREDALIAS}_DlgObj.getValue(\'COMPID\')+\'||mFromD|Date|\'+{UXPRERENDEREDALIAS}_DlgObj.getValue(\'FROMDATE\')+\'||mToD|Date|\'+{UXPRERENDEREDALIAS}_DlgObj.getValue(\'TODATE\')+\'\';',
'\tro.rawArgumentMapping = \'mcomid|Numeric|{compid}||mFromD|Date|{FromDate}||mToD|Date|{ToDate}\';',
'\tro.controlReferences = [\'COMPID\',\'FROMDATE\',\'TODATE\'];',
...
'\t"__dialogGuid": "f3e94302-5ae9-40b1-9991-eef25d38a31b",',
...
'COMPID:\'PANELCARD_1\',',
'LIST_OF_INVOICES:\'PANELCARD_1\',',
'FROMDATE:\'PANELCARD_1\',',
'TODATE:\'PANELCARD_1\',',
'MEDREPN:\'PANELCARD_1\'',
'}',
'{UXPRERENDEREDALIAS}_DlgObj._controlsOnPanel = {',
'\t\'PANELCARD_1\' : {controls: [\'CURRENTUSER\',\'COMPID\',\'LIST_OF_INVOICES\',\'FROMDATE\',\'TODATE\',\'MEDREPN\']}',
'}',
...
'\thtml: \'View list of the selected Rep.\',',
'\tonClick: function() { ',
'},',
...
'{UXPRERENDEREDALIAS}_DlgObj._actions[\'Open_Report\'] = \'/* actionJavascript:3413b970-9548-45e4-901d-c5c853643962*/{UXPRERENDEREDALIAS}_O_EB2B819C7D9F4C8E9E97A957B1154B2E(1,\\\'1\\\',this);\\n\';',
'{UXPRERENDEREDALIAS}_DlgObj._actions[\'Open_Report_ADM\'] = \'{UXPRERENDEREDALIAS}_ACTION_OpenReportADM(1,\\\'1\\\',this);\';',
';',
'window[\'{UXPRERENDEREDALIAS}_O_EB2B819C7D9F4C8E9E97A957B1154B2E\'] = function(rowNum,rowId,objEle) {',
'var runMethod = \'ajax\';',
'if(runMethod == \'ajax\') {',
'if(typeof {UXPRERENDEREDALIAS}_DlgObj._onlineStatus != \'undefined\') { ',
'\tif({UXPRERENDEREDALIAS}_DlgObj._onlineStatus == \'offline\') { ',
...
'\tro.clientSideFilename = \'\';',
'\tro.reportMessagesDivId = \'\';',
'\tro.filter = \'medrepn = `\'+{UXPRERENDEREDALIAS}_DlgObj.getValue(\'CURRENTUSER\')+\'` .OR. supervisorn = `\'+{UXPRERENDEREDALIAS}_DlgObj.getValue(\'CURRENTUSER\')+\'` .OR. areamanager = `\'+{UXPRERENDEREDALIAS}_DlgObj.getValue(\'CURRENTUSER\')+\'` .OR. lmanager= `\'+{UXPRERENDEREDALIAS}_DlgObj.getValue(\'CURRENTUSER\')+\'`\';',
'\tro.order = \'\';',
'\tro.sqlFilter = \'\';',
'\tro.sqlOrder = \'\';',
'\tro.arguments = \'mcomid|Numeric|session.compid||mFromD|Date|\'+{UXPRERENDEREDALIAS}_DlgObj.getValue(\'FROMDATE\')+\'||mToD|Date|\'+{UXPRERENDEREDALIAS}_DlgObj.getValue(\'TODATE\')+\'\';',
'\tro.rawArgumentMapping = \'mcomid|Numeric|session.compid||mFromD|Date|{FromDate}||mToD|Date|{ToDate}\';',
...
'\tA5.component.runReport(ro);',
'}',
'window[\'{UXPRERENDEREDALIAS}_ACTION_OpenReportADM\'] = function(rowNum,rowId,objEle) {',
'var runMethod = \'ajax\';',
'if(runMethod == \'ajax\') {',
'if(typeof {UXPRERENDEREDALIAS}_DlgObj._onlineStatus != \'undefined\') { ',
'\tif({UXPRERENDEREDALIAS}_DlgObj._onlineStatus == \'offline\') { ',
...
'ele.innerHTML = \'\\n<div style="display:none;"><span><input\\ttype="text" id="{UXPRERENDEREDALIAS}.V.R1.CURRENTUSER" title=""     class="[theme:edit.base.className|class.dialogInput] " style=""  onchange="var tfunc = function() {onChange_currentuser_62083363127a4993a70874204981601b.call(this,{UXPRERENDEREDALIAS}_DlgObj);;}; var tscope = this; setTimeout(function() { if(tscope) { tfunc.call(tscope);} delete tscope;},1 );"   name="V.R1.CURRENTUSER"    value=""    />\\n</span>\\n<span><input\\ttype="text" id="{UXPRERENDEREDALIAS}.V.R1.COMPID" title=""     class="[theme:edit.base.className|class.dialogInput] " style=""  onchange="var tfunc = function() {onChange_compid_d099dd92ddc847f4bb7f7a1f0340da79.call(this,{UXPRERENDEREDALIAS}_DlgObj);;}; var tscope = this; setTimeout(function() { if(tscope) { tfunc.call(tscope);} delete tscope;},1 );"   name="V.R1.COMPID"    value=""    />\\n</span>\\n</div>\\n\';',
...
'{UXPRERENDEREDALIAS}_DlgObj.__guid = \'f3e94302-5ae9-40b1-9991-eef25d38a31b\';',
...
'\t\'TODATE\' : {dateformat: \'<DefaultDateOnlyFormat>\'}',
'}',
...
'var _disabled = this.disabled; if(typeof _disabled == \'undefined\') _disabled = false; if(!_disabled) {;var flagLocked = false; if (typeof this._locked != \'undefined\') flagLocked = this._locked;  if(!flagLocked) {{UXPRERENDEREDALIAS}_O_1D337118D73C4466B5137F41409F3A4B(1,\'1\',this); } ; this._locked = true; flagLocked = true; var that = this; setTimeout(function() { that._locked = false; },300);}',
...
'',
'',
';{UXPRERENDEREDALIAS}_DlgObj.setStateInfo({ \t__args_n_COMPID: \'7\', \targValuesENC: \'7C3tO+HPao3KjJzM8+/lcfdCh/SADeT4rwYj/0c8b4o=\', \t__debugInfo: \'ssi-6014\' });//ssi-6014;',
';',
'',
'',
'setTimeout(function() { ;',
